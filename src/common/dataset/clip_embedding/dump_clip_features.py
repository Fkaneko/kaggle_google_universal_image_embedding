# from https://github.com/facebookresearch/Detic/blob/main/tools/dump_clip_features.py
...
if __name__ == "__main__":
    ...
    if args.model == "clip":
        ...
        print("Loading CLIP")
        model, preprocess = clip.load(args.clip_model, device=torch.device("cpu"))
        # for fp32 output firstly load cpu -> https://github.com/openai/CLIP/issues/30#issuecomment-1029455112
