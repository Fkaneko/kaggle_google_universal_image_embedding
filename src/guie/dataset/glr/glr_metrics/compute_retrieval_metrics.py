...
def main(argv):
    ...
    public_predictions, private_predictions = dataset_file_io.ReadPredictions(
        cmd_args.predictions_path,
        set(public_solution.keys()),
        set(private_solution.keys()),
        set(ignored_ids),
    ...
    print("**********************************************")
    print(
        "(Public)  Mean Average Precision: %f"
        % metrics.MeanAveragePrecision(public_predictions, public_solution)
    )
    print(
        "(Private) Mean Average Precision: %f"
    ...
    print(
        "(Public)  Mean precisions: P@1: %.2f, P@5: %.2f, P@10: %.2f, "
        "P@50: %.2f, P@100: %.2f"
        % (
            public_precisions[0],
            public_precisions[4],
            public_precisions[9],
            public_precisions[49],
            public_precisions[99],
        )
    )
    print(
        "(Private) Mean precisions: P@1: %.2f, P@5: %.2f, P@10: %.2f, "
        "P@50: %.2f, P@100: %.2f"
        % (
            private_precisions[0],
            private_precisions[4],
            private_precisions[9],
            private_precisions[49],
            private_precisions[99],
        )
    )
    ...
    print(
        "(Public)  Mean position: %.2f, median position: %.2f"
        % (public_mean_position, public_median_position)
    )
    print(
        "(Private) Mean position: %.2f, median position: %.2f"
