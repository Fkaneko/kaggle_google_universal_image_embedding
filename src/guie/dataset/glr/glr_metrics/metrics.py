...
def GlobalAveragePrecision(predictions, recognition_solution, ignore_non_gt_test_images=False):
    ...
    sorted_predictions = sorted(
        sorted_predictions_by_key_class, key=lambda item: item[1]["score"], reverse=True
    )
